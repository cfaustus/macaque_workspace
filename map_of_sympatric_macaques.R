...
setwd("/Users/cfaust/Dropbox/Princeton/Projects/SimianMalaria/AlphaGlobin/SHP")

#Import shapefiles
fascicularis_range=readShapePoly("Macaca fascicularis.shp")
nemestrina_range=readShapePoly("Macaca nemestrina.shp")
arctoides_range=readShapePoly("Macaca arctoides.shp")
